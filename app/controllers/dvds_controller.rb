class DvdsController < ApplicationController
  ...
  # POST /dvds.json
  def create
    @dvd = @user.dvds.build(dvd_params)

    respond_to do |format|
      if @dvd.save
        format.html { redirect_to [@user, @dvd], notice: 'Dvd was successfully created.' }
  ...
  private
    ...
    def dvd_params
      params.require(:dvd).permit(:title, :genre, :year, :rating, :description, :user_id)
    end
end
